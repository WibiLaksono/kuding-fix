...
export default function Navbar() {
    const navMenus = Array(5).fill(null);
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-20 sm:h-32 bg-white shadow-lg z-50">
            ...
            <div className="w-full h-[20%] bg-blue-600 flex justify-center">
                <p className="text-white font-light text-xs sm:text-lg">LIMITED OFFER: 30% OFF. Use RABBIT30 at Checkout.</p>
            </div>
            ...
            <div className="flex justify-center w-full h-[80%] bg-white sm:hidden">
                <div className="flex flex-row justify-between items-center px-5 w-full h-full">
                    {/* Logo */}
                    <a href="#" className="text-red-600 text-xl font-bold font-sans">Kuding</a>
                ...
                {isOpen && (
                    <div className="absolute top-20 left-0 w-full bg-white shadow-md py-3 flex flex-col items-center gap-3 ">
                        ...
                        <a href="#" className="text-gray-800 text-sm">Range Harga v</a>
                        <a href="#" className="text-gray-800 text-sm">Lokasi v</a>
                    </div>
                )}
            </div>
            ...
            <div className="sm:flex flex-col w-full h-[85%] bg-white hidden">
                        ...
                        {/* Search Bar */}
                                                <div className="flex flex-row justify-center items-center gap-2 w-[40%] h-full ">
                                                    ...
                                                    <button
                                                        ...
                                                        name="search"
                                                        id="search"
                                                        className="flex items-center justify-center bg-blue-300 w-[20%] h-[60%] rounded-full cursor-pointer"
                                                    >
                                                        Cari
                                                    </button>
                                                </div>
                                                ...
                                                <div className="flex flex-row justify-end items-center px-2 gap-2 w-[30%] h-full">
                                                    ...
                                                    <div className="w-[20%] h-[60%] bg-amber-200 flex items-center justify-center rounded-full cursor-pointer">
                                                        Notif
                                                    </div>
                                                </div>
                                        </div>
                ...
                <div className="flex flex-row justify-center px-10 w-full h-10">
                    {navMenus.map((_, index) => (
                        <div key={index} className="w-[15%] h-full flex items-center justify-center cursor-pointer">
                            Menu List {index + 1}
                        </div>
                    ))}
                    <div className="flex flex-row gap-20 w-[20%] h-full items-center justify-center">
                        <div className="cursor-pointer">Range Harga v</div>
                        <div className="cursor-pointer">Lokasi v</div>
                    </div>
                </div>
            </div>
        </div>
